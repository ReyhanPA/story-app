package com.reyhanpa.storyapp.data.local.mediator
    ...
    override suspend fun load(
        ...
        try {
            ...
            database.withTransaction {
                ...
                val entityList = responseData.listStory.toEntityList()
                ...
                database.storyDao().insertStories(entityList)
            }
